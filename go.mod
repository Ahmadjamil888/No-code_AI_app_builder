...
require (
	...
	github.com/charmbracelet/bubbletea/v2 v2.0.0-beta.4.0.20250808190645-68df41d24270
	github.com/charmbracelet/catwalk v0.4.10
...
require (
	...
	github.com/charmbracelet/ultraviolet v0.0.0-20250805213125-4167e4d7080b
